            ...
            <v-container>
              <v-row>
                <component
                  ...
                  :key="header.value"
                  :cols="['textarea'].includes(header.input) ? 12 : 6"
                >
                  <v-text-field
                    v-if="
                      header.input === 'text' ||
                  ...
                  <component
                    ...
                    :label="header.text"
                    color="#90a4ae"
                    :item-text="header.autocomplete_name || 'name'"
                    item-value="id"
                    :value="item[header.value]"
                  ...
                  >
                    ...
                    <template #item="data">
                      ...
                      <template v-else>
                        <v-list-item-content>
                          <v-list-item-title>
                            {{ data.item[header.autocomplete_name || "name"] }}
                          </v-list-item-title>
                        </v-list-item-content>
                      </template>
                    </template>
...
export default {
  ...
  methods: {
    ...
    getItemsNolimit(
      ...
      let url = `/${baseUrl}${paramString}page=${page}&size=${itemsPerPage}&query=${encodeURIComponent(
        search
      )}`
